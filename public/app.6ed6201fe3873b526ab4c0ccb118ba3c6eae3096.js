...
// button appearing when scroll into section
    ...
    for (i = 0; i < sectionNames.length; i++) {
      ...
      if(wScroll > $('.'+sectionNames[i]).offset().top) {
        $('.'+sectionNames[i] + ' .button-ghost').addClass('btn-appear');
      }
    }
